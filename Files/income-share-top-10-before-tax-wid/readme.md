# Income share of the richest 10% (before tax) - Data package

This data package contains the data that powers the chart ["Income share of the richest 10% (before tax)"](https://ourworldindata.org/grapher/income-share-top-10-before-tax-wid?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on January 26, 2026.
...
#### Full citation
World Inequality Database (WID.world) (2025) – with major processing by Our World in Data. “Share (top 10%, before tax) – WID” [dataset]. World Inequality Database (WID.world), “World Inequality Database (WID)” [original data].

...
# 
# - **Global Distribution:** How have the Gini Index and HDI diverged across geographic regions throughout the MDG and SDG eras (2000–2024)?
# - **The Extremes of Wealth:** Which ten countries exhibit the highest concentration in the Income_Share (Top 1%), and how does this correlate with their Monthly Employee Earnings?
# - **The Inclusion Gap:** In countries showing positive trends in the Human Development Index, has the Income_Share for the bottom 50% remained stagnant or improved?
# 
...
# - **The Digital Divide:** To what extent does Internet Access act as a gatekeeper for labor market participation, as measured by the Unemployment_Rate (Age 15+)?
# - **The Gender Variable:** Utilizing our Sex dimension, what is the observable gap in Monthly Employee Earnings across different regions, and how does it relate to female participation in the labor force?
# 
# ### 2.3. 🚀 Predictive & Resilience Analysis (What Now?)
# 
# - **Economic Contextual Impact:** Using our Economic Context categories, did the "2008 Financial Crisis" lead to a permanent shift in Income_Share concentration compared to the "Post-COVID Recovery" period?
# - **Labor Market Resilience:** Did countries with lower initial Unemployment Rates (15+) during the "Global Growth Period" show higher resilience in HDI scores during the COVID-19 shock?
# - **Barriers to Mobility:** Which indicator in the Social_Barriers table (Literacy, Life Expectancy, or MPI) serves as the strongest statistical predictor for a country falling into the bottom quartile of Monthly Earnings?
...
# 
# - **Sex:** A small but vital lookup table that defines gender categories. It allows the model to split labor and social metrics by gender for comparative analysis.
# 
...
# ## 5. Challenges 
# 
# ### 5.1. Challenges in Data Acquisition (UN Census)
...
# 
# ### 5.4. Redundant and Static Values.
...
# 
# ### 5.5. Infrastructure and Resource Constraints (Microsoft Fabric)
...
# 
# Campos: Country_Code, Year, Gini_Index, GDP_per_Capita, GDP_Annual_Growth_Pct, Inflation_CPI_Pct, HDI.
# 
# O que responde: Distribuição Global, Evolução Temporal e Fatores Determinantes.
# 
# Fact_Wealth_Distribution (The Extremes Table)
# 
# Campos: Country_Code, Year, Top_1_Share, Top_10_Share, Middle_40_Share, Bottom_50_Share.
# 

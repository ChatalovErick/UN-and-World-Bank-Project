...
# - HDI [x]
# - gini index [x]
# - monthly employee earnings [x]
#     - sex code: total [x]
#     - currency: dollar [x]
# 
# - GDP per capita [Vasco]
# 
# - Unemployment rate: [x]
#     - sex code: total [x]
#     - age code: 18+ [x]
# 
# ### Tabela 2
# - income_share (top 10%, top 1%, middle 40%, bottom 50%) [x]
# 
# ### Tabela 3 
# - MPI (apenas para paises desiguais) [x]
# 
# - School attendence [x]
# - literacy rate [x]
# - internet access [x]
# - female account ownership [x]
